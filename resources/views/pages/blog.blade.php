...
<html lang="en" class="no-js">
  <head>
    <title>Blog - 229 Consulting</title>
    ...
    <meta name="description" content="Read the latest insights from 229 Consulting on business strategy, GenAI adoption, public sector consulting, and transformation best practices.">
    <meta name="keywords" content="business consulting blog, strategy insights, GenAI adoption, public sector consulting, business transformation, 229 consulting">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="Blog - 229 Consulting">
    <meta property="og:description" content="Stay informed with the latest business consulting insights, strategies, and industry trends from 229 Consulting.">
      ...
      <div class="page-blog mt-100">
        <div class="container">
          <div class="row product-grid">
            ...
            <div class="col-12 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="{{ (($index % 3) + 1) * 100 }}">
              <div class="card-blog radius18">
                ...
                <a class="card-blog-bottom" href="{{ route('blog.detail', ['slug' => $post->slug]) }}" aria-label="Blog details">
            ...
            <div class="col-12 text-center" data-aos="fade-up">
              <p class="text text-18">No blog posts available at the moment.</p>
                    </div>
            @endif
          </div>
