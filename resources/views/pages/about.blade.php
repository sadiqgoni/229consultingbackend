...
<head>
    <title>About Us - 229 Consulting</title>
 ...
 <link rel="manifest" href="{{ asset('assets/img/site.webmanifest') }}">
    ...
    <meta name="description"
        content="Learn about 229 Consulting - we deliver actionable strategy and execution support to organizations navigating disruption, growth, and transformation. Beyond pitch decks—we carry the work forward until it translates into real outcomes.">
    <meta name="keywords"
        content="business consulting, strategy, execution, transformation, growth, disruption, organizational development, about us">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="About Us - 229 Consulting">
    ...
    <meta name="twitter:title" content="About Us - 229 Consulting">
...
<body>
                    ...
                    <drawer-menu>
                        <nav class="header-nav drawer-menu">
                            ...
                            <ul class="header-menu list-unstyled">
                                <li class="nav-item">
                                    <a class="menu-link menu-link-main menu-accrodion" href="/" data-text="Home">
                                        Home
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="menu-link menu-link-main active" href="/about">
                                        About Us
                                    </a>
                                </li>
        ...
        <div class="drawer-content">
            <div class="drawer-block">
                ...
                <ul class="drawer-additional-menu list-unstyled flex-direction-column">
                    ...
                    <li class="nav-item">
                        <a class="menu-link" href="/services"> Training & Capacity Building
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="drawer-additional-menu list-unstyled flex-direction-column">
                    ...
                    <li class="nav-item">
                        <div class="menu-link no-hover">
                            ...
                            <span>hello@229consulting.com</span>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <main>
        ...
        <div class="page-banner overlay">
            <picture class="media media-bg">
                <img src="{{ asset('assets/img/banner/banner.jpg') }}" width="1920" height="auto" loading="eager"
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-12">
                        <div class="media-wrap" data-aos="zoom-in-up">
                            <img src="{{ asset('assets/img/image-text/img2.png') }}" width="992" height="863"
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="content section-headings">
                            ...
                            <div class="text text-18" data-aos="fade-up">
                                We help organizations navigate change with clarity and purpose. In a world where
                                disruption is constant, 229 Consulting empowers institutions to adapt, grow, innovate,
                            ...
                            <ul class="text-lists list-unstyled">
                                ...
                                <li class="text-item text text-18" data-aos="fade-up">
                                    ...
                                    Equip teams with future-ready strategies
                                </li>
                                <li class="text-item text text-18" data-aos="fade-up">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                        viewbox="0 0 28 28" fill="none">
                                    ...
                                    Build resilience through innovation and foresight
                                </li>
                                <li class="text-item text text-18" data-aos="fade-up">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                        viewbox="0 0 28 28" fill="none">
                                    ...
                                    Leverage AI and global trends for sustainable growth
                                </li>
                            </ul>
                            <div class="text text-18" data-aos="fade-up" style="margin-top: 30px;">
                                We don't just prepare you for the future — we help you own it.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Brand Logo -->
        <div class="running-content mt-2">
            <div class="container">
        ...
        <!-- Why Choose Us -->
        <div id="services" class="why-choose-us bg-transparent mt-100 section-padding">
            <div class="media media-bg">
                <img src="{{ asset('assets/img/why-choose-us/bg.jpg') }}" alt="choose us background image"
                    width="1920" height="887" loading="lazy">
            </div>
            <div class="container">
                        ...
                        <div class="col-12 col-lg-6">
                            <picture class="choose-media radius18" data-aos="fade-right">
                                <source media="(max-width: 575px)"
                                    srcset="{{ asset('assets/img/why-choose-us/575.jpg') }}">
                                <img src="{{ asset('assets/img/why-choose-us/growth.jpg') }}" alt="choose us image"
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="choose-us-content section-headings">
                                ...
                                <p class="text text-18" data-aos="fade-up">
                                    We help organisations unlock productivity and resilience by embedding Generative AI
                                    into their people, processes, and systems — driving efficiency, transparency, and
                                    readiness for the future of work.
                                </p>

                                <div class="choose-logo">
                                    <div class="choose-rotating-logo svg-wrapper" data-aos="zoom-in-up">
                                        <svg class="infinite-rotate" viewbox="0 0 179 179" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="89" cy="89" r="60" fill="#2b999f"></circle>
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="#1C2539"></path>
                                            <path
                                                d="M160.271 138.111L149.358 130.75L150.25 129.428L161.162 136.79L160.271 138.111Z"
                                                fill="#1C2539"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="#1C2539"></path>
                                            <path
                                                d="M96.4579 168.464L96.2783 167.061L101.991 166.33L102.17 167.732L96.4579 168.464Z"
                                                fill="#1C2539"></path>
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="#1C2539"></path>
                                            <path
                                                d="M18.149 40.2678L29.0404 47.661L28.1451 48.9798L17.2537 41.5866L18.149 40.2678Z"
                                                fill="#1C2539"></path>
                                            <path
                        ...
                        <div class="row">
                                ...
                                <div class="card-icon-text card-icon-text-horizontal">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="text text-16">
                                            To be the leading strategic partner helping unlock organizational potential
                                            and shaping institutions that drive progress, resilience, and shared
                                            prosperity for humanity's future.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-icon-text card-icon-text-horizontal">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="text text-16">
                                            ...
                                            businesses, governments, and institutions to thrive in a rapidly changing
                                            world.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="200">
                                <div class="card-icon-text card-icon-text-horizontal">
                                    ...
                                    <div class="content">
                                        <h2 class="heading text-20 fw-700">Our Core Values </h2>
                                        <p class="text text-16">
                                            Our work is guided by principles that define who we are and how we deliver
                                            impact through integrity, excellence, curiosity, collaboration, impact, and
                                            innovation.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="card-team radius18">
                                    ...
                                    <div class="card-team-content-absolute">
                                        <div class="card-team-content">
                                            <a href="/team-details" aria-label="team details"
        ...
        <!-- Testimonial -->
        <div id="team" class="testimonial mt-100 section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12">
                        <div class="testimonial-card-inner">
                            <div class="card-testimonial radius18" data-aos="fade-up" data-aos-delay="10">
                                ...
                                <p class="text text-24">"229 Consulting delivered exceptional results in designing our commodity exchange market framework. Their comprehensive approach, from regulatory approvals to operational design, positioned us as a leading player in Nigeria's commodity sector. The team's expertise and strategic vision were instrumental in our success."</p>
                                <div class="user-info-wrap">
                                    <div class="user-info">
                                        <div class="user-name-desig">
                                            <h2 class="user-name heading text-24">MARCX & CONSTRUCTION LTD.</h2>
                                            <div class="user-desig text text-18">Client Partner</div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-testimonial radius18" data-aos="fade-up" data-aos-delay="150">
                                ...
                                <p class="text text-24">"During our company's downturn, 229 Consulting's divestment strategy was a game-changer. Their analytical approach to asset management and strategic capital reallocation helped us preserve liquidity and invest in high-growth opportunities. The results exceeded our expectations and strengthened our long-term resilience."</p>
                                <div class="user-info-wrap">
                                    <div class="user-info">
                                        <div class="user-name-desig">
                                            <h2 class="user-name heading text-24">EKŞIOĞULLARI CONSTRUCTION</h2>
                                            <div class="user-desig text text-18">Executive Director</div>
                                        </div>
                                    </div>
                                    <div class="icon-quote">
                                        <svg class="icon icon-62" width="62" height="62"
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="section-headings">
                            ...
                            <div class="text text-18" data-aos="fade-up" data-aos-delay="80">
                                ...
                                and we'll provide personalized guidance for your consulting needs.
                            </div>
                            <div class="buttons" data-aos="fade-up" data-aos-delay="100">
                                <a href="/about" class="button button--primary" aria-label="Ask Your Question">
                                    Ask Your Question
                                    <span class="svg-wrapper">
                                        <svg class="icon-20" width="20" height="20" viewbox="0 0 20 20"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="image-absolute" data-aos="zoom-in">
                                <img src="{{ asset('assets/img/faq/question.png') }}" width="104"
                                    height="180" loading="lazy" alt="Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <faq-accordion>
                            <div class="accordion-list">
                                <div class="accordion-block" data-aos="fade-up">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            We specialize in multiple sectors including public sector organizations, private companies undergoing transformation, commodity markets, construction and real estate firms, and institutions adopting emerging technologies. Our expertise spans across industries facing disruption, growth challenges, or operational excellence needs. Each engagement is tailored to the specific industry context and challenges.
                                ...
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="50">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            The duration of our consulting engagements varies based on project complexity and scope. Strategic planning initiatives typically range from 3-6 months, while comprehensive transformation programs can extend to 12-18 months. We work collaboratively with clients to establish realistic timelines that balance thorough analysis with practical implementation, ensuring sustainable outcomes rather than rushed solutions.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Client confidentiality is paramount in our practice. We implement comprehensive security protocols including NDA agreements, secure data handling procedures, encrypted communications, and restricted access to sensitive information. Our team undergoes regular security training, and we adhere to international data protection standards. All client information is treated with the highest level of discretion and professional ethics.
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <footer>
        <!-- Footer Main -->
        <div class="footer-main bg-contain mt-100"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="footer-widget footer-widget-menu" data-aos="fade-up"
                                ...
                                <ul class="footer-menu list-unstyled">
                                    ...
                                    <li>
                                        <a href="/projects" class="text text-16 link" aria-label="Impact Story">
                                            Impact Story
                                        </a>
                                    </li>
                                    <li>
