...
<html lang="en" class="no-js">
  <head>
    <title>Team Member Details - 229 Consulting</title>
 ...
 <link rel="manifest" href="{{ asset('assets/img/site.webmanifest') }}">
    ...
    <meta name="description" content="Meet our expert consultants and team members at 229 Consulting. Learn about their backgrounds, expertise, and contributions to our success.">
    <meta name="keywords" content="consulting team, business consultants, Ahmad Mukhtar Mustafa, Muhammad Rabiu Gambo, Murtala Umar Adamu, Al-Amin Masu, Hassan Adelakin, team profiles">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="Team Member Details - 229 Consulting">
    <meta property="og:description" content="Discover the expertise and backgrounds of our consulting team members who drive innovation and results for our clients.">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Team Member Details - 229 Consulting">
    <meta name="twitter:description" content="Meet the expert consultants at 229 Consulting who deliver exceptional results for our clients.">
    ...
    <style>
      ...
      /* Social icons hover color - brand green */
            ...
            <div class="col-md-6 col-12 td-column">
              <div class="td-media-wrap" data-aos="fade-up">
                <div class="td-media radius18">
                  <img id="team-image" src="{{ asset('assets/img/team/td-1.jpg') }}" width="1000" height="1133" loading="lazy" alt="Team Member">
                </div>
              </div>
            </div>
            <div class="col-md-6 col-12">
              <div class="content-info">
                <h2 id="team-name" class="heading text-50" data-aos="fade-up">
                </h2>
                <div id="team-position" class="info-desig heading text-22" data-aos="fade-up" data-aos-delay="50" style="color: #17a2b8;">
                </div>
                <p id="team-bio" class="info-desc text text-18" data-aos="fade-up" data-aos-delay="100" style="margin-top: 30px;">
                </p>
                <ul class="social-icons list-unstyled">
                  <li data-aos="fade-up" data-aos-delay="100">
                    <a id="team-email" class="social-link text" href="mailto:" target="_blank">
                      <svg width="20" height="16" viewbox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 0H2C0.9 0 0.00999999 0.9 0.00999999 2L0 14C0 15.1 0.9 16 2 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0ZM18 4L10 9L2 4V2L10 7L18 2V4Z" fill="currentColor"></path>
                      </svg>
                      <span class="visually-hidden">Email</span>
                    </a>
                  </li>
                  <li data-aos="fade-up" data-aos-delay="200">
                    <a id="team-linkedin" class="social-link text" href="https://www.linkedin.com/company/229-consulting/" target="_blank">
                  ...
                  <li data-aos="fade-up" data-aos-delay="300">
                    <a id="team-twitter" class="social-link text" href="https://x.com/" target="_blank">
  ...
  <scroll-top>
    ...
    <!-- Team Details Dynamic Loading -->
    <script>
      // Team data
      const team = {
        'ahmad': {
          name: 'Ahmad Mukhtar Mustafa',
          position: 'Lead, Private Sector',
          bio: 'An Electrical engineer with fintech expertise, advising globally on energy, finance, and social impact initiatives.',
          image: 'assets/img/team/img1.jpeg',
          email: 'a.mukhtar@229consult.com',
          linkedin: 'https://www.linkedin.com/company/229-consulting/',
          twitter: 'https://x.com/'
        },
        'muhammad': {
          name: 'Muhammad Rabiu Gambo',
          position: 'Partner, Lead Public Sector',
          bio: 'An Aerospace engineer turned finance professional, specializing in fintech innovation, asset management, and cross-sector investment strategies.',
          image: 'assets/img/team/img2.jpeg',
          email: 'mrgambo@229consult.com',
          linkedin: 'https://www.linkedin.com/company/229-consulting/',
          twitter: 'https://x.com/'
        },
        'murtala': {
          name: 'Murtala Umar Adamu',
          position: 'Principal Consultant',
          bio: 'Blends research, data analytics, and communication to drive evidence-based strategies across energy, tech, and emerging markets.',
          image: 'assets/img/team/img3.jpeg',
          email: 'murtala@229consult.com',
          linkedin: 'https://www.linkedin.com/company/229-consulting/',
          twitter: 'https://x.com/'
        },
        'alamin': {
          ...
          bio: 'A software engineer, marketing strategist, and systems optimization expert with a proven track record in the entrepreneurial ecosystem.',
          image: 'assets/img/team/img5.jpeg',
          email: 'alamin@229consult.com',
          linkedin: 'https://www.linkedin.com/company/229-consulting/',
          twitter: 'https://x.com/'
        },
        'hassan': {
          name: 'Hassan Adelakin',
          position: 'Chief Communications Officer',
          bio: 'An economist and communications strategist with a strong background in digital marketing, social media management, and content development.',
          image: 'assets/img/team/img4.jpeg',
          email: 'hassan@229consult.com',
          linkedin: 'https://www.linkedin.com/company/229-consulting/',
          twitter: 'https://x.com/'
        }
      };

      // Load team member details on page load
      window.addEventListener('load', function() {
        ...
        if (!member) {
          console.log('Member not found, using default');
          // If no member found, default to ahmad
          const defaultMember = team['ahmad'];
          updatePage(defaultMember);
        } else {
        ...
        function updatePage(member) {
          ...
          const teamLinkedin = document.getElementById('team-linkedin');
          const teamTwitter = document.getElementById('team-twitter');
          
          if (teamImage) teamImage.src = member.image;
          if (teamName) teamName.textContent = member.name;
          if (teamPosition) teamPosition.textContent = member.position;
          if (teamBio) teamBio.textContent = member.bio;
          if (teamEmail) teamEmail.href = 'mailto:' + member.email;
          if (teamLinkedin) teamLinkedin.href = member.linkedin;
          if (teamTwitter) teamTwitter.href = member.twitter;
          
          // Update page title in banner
          const pageBannerTitle = document.querySelector('.page-banner-content h1');
          if (pageBannerTitle) {
            pageBannerTitle.textContent = member.name;
          }
          
          console.log('Page updated with member data');
        }
      });
    </script>
  </body>
