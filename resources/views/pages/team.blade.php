...
<html lang="en" class="no-js">
  <head>
    <title>Our Team - 229 Consulting</title>
    ...
    <meta name="description" content="Meet the expert team at 229 Consulting - experienced consultants specializing in business transformation, strategy implementation, and organizational growth.">
    <meta name="keywords" content="consulting team, business consultants, strategy experts, transformation specialists, management consultants, 229 Consulting team">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="Our Team - 229 Consulting">
    <meta property="og:description" content="Meet our experienced consulting team dedicated to driving business transformation and sustainable growth for organizations.">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Our Team - 229 Consulting">
    <meta name="twitter:description" content="Meet the expert consultants at 229 Consulting who drive business transformation and strategic growth.">
  ...
  <div class="theme-drawer drawer-additional" data-position="right">
   ...
   <div class="page-banner overlay">
          ...
          <div class="row product-grid">
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="100">
              <div class="card-team radius18">
                <img src="{{ asset('assets/img/team/img1.jpeg') }}" alt="team image" width="500" height="619" loading="lazy">
                <div class="card-team-content-absolute">
                  <div class="card-team-content">
                    <a href="/team-details?member=ahmad" aria-label="team details" class="heading text-22 fw-600">Ahmad Mukhtar Mustafa</a>
                    <p class="text text-18">Lead, Private Sector</p>
                  </div>
                </div>
                <div class="social-list">
                  <a href="#" class="svg-wrapper" aria-label="LinkedIn">
                    <svg class="icon icon-20" xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewbox="0 0 17 16" fill="none">
                  ...
                  <a href="#" class="svg-wrapper" aria-label="twitter">
                    <svg class="icon icon-20" xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewbox="0 0 18 14" fill="none">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="200">
              <div class="card-team radius18">
                <img src="{{ asset('assets/img/team/img2.jpeg') }}" alt="team image" width="500" height="619" loading="lazy">
                <div class="card-team-content-absolute">
                  <div class="card-team-content">
                    <a href="/team-details?member=muhammad" aria-label="team details" class="heading text-22 fw-600">Muhammad Rabiu Gambo</a>
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="300">
              <div class="card-team radius18">
                <img src="{{ asset('assets/img/team/img3.jpeg') }}" alt="team image" width="500" height="619" loading="lazy">
                <div class="card-team-content-absolute">
                  <div class="card-team-content">
                    <a href="/team-details?member=murtala" aria-label="team details" class="heading text-22 fw-600">Murtala Umar Adamu</a>
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="400">
              <div class="card-team radius18">
                <img src="{{ asset('assets/img/team/img5.jpeg') }}" alt="team image" width="500" height="619" loading="lazy">
                <div class="card-team-content-absolute">
                  <div class="card-team-content">
                    <a href="/team-details?member=alamin" aria-label="team details" class="heading text-22 fw-600">Al-Amin Masu</a>
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="100">
              <div class="card-team radius18">
                <img src="{{ asset('assets/img/team/img4.jpeg') }}" alt="team image" width="500" height="619" loading="lazy">
                <div class="card-team-content-absolute">
                  <div class="card-team-content">
                    <a href="/team-details?member=hassan" aria-label="team details" class="heading text-22 fw-600">Hassan Adelakin</a>
    ...
    <!-- Make team cards fully clickable -->
    <script>
