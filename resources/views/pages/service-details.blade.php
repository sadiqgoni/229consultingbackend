...
<html lang="en" class="no-js">
  <head>
    <title>Service Details - 229 Consulting</title>
    ...
    <meta name="description" content="Detailed service information for 229 Consulting: GenAI Adoption, Public Sector Consulting, Strategy & Leadership Advisory, and Training & Capacity Building. Comprehensive solutions for organizational transformation.">
    <meta name="keywords" content="business consulting services, GenAI adoption, public sector consulting, strategy advisory, leadership development, capacity building, organizational transformation, consulting services">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="Service Details - 229 Consulting">
    <meta property="og:description" content="Explore our comprehensive consulting services: AI adoption, public sector consulting, strategy advisory, and leadership development. Beyond theory - we deliver real outcomes.">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Service Details - 229 Consulting">
    <meta name="twitter:description" content="Detailed information about our business consulting services and solutions.">
  ...
  <div class="theme-drawer drawer-additional" data-position="right">
    ...
    <div class="drawer-content">
      <div class="drawer-block">
        ...
        <ul class="drawer-additional-menu list-unstyled flex-direction-column">
          <li class="nav-item">
            <a class="menu-link" href="/services">Services Overview</a>
          </li>
          <li class="nav-item">
            <a class="menu-link" href="/service-details">Detailed Services</a>
          </li>
        </ul>
      </div>
      <div class="drawer-block drawer-block-contact">
          ...
          <div class="row">
                ...
                <aside class="service-sidebar">
                  <div class="sidebar-widget radius18" data-aos="fade-up">
                    ...
                    <ul class="secvice-categories list-unstyled">
                      ...
                      <li>
                        <a class="secvice-category subheading subheading-bg text-18 fw-400" href="#" data-service="strategy" aria-label="blog category">
                      ...
                      <li>
                        <a class="secvice-category subheading subheading-bg text-18 fw-400" href="#" data-service="training" aria-label="blog category">
                          Training & Capacity Building
                          <svg viewbox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.6895 7.25095H0.75C0.551088 7.25095 0.360322 7.32997 0.21967 7.47062C0.0790178 7.61127 0 7.80203 0 8.00095C0 8.19986 0.0790178 8.39063 0.21967 8.53128C0.360322 8.67193 0.551088 8.75095 0.75 8.75095H14.6895L9.219 14.2199C9.07817 14.3608 8.99905 14.5518 8.99905 14.7509C8.99905 14.9501 9.07817 15.1411 9.219 15.2819C9.35983 15.4228 9.55084 15.5019 9.75 15.5019C9.94916 15.5019 10.1402 15.4228 10.281 15.2819L17.031 8.53195C17.1008 8.46228 17.1563 8.37951 17.1941 8.2884C17.2319 8.19728 17.2513 8.0996 17.2513 8.00095C17.2513 7.9023 17.2319 7.80462 17.1941 7.7135C17.1563 7.62238 17.1008 7.53962 17.031 7.46995L10.281 0.719947C10.1402 0.579117 9.94916 0.5 9.75 0.5C9.55084 0.5 9.35983 0.579117 9.219 0.719947C9.07817 0.860777 8.99905 1.05178 8.99905 1.25095C8.99905 1.45011 9.07817 1.64112 9.219 1.78195L14.6895 7.25095Z" fill="currentColor"></path>
                          </svg>
            ...
            <div class="col-12 col-lg-7">
              <div class="service-details-content">
                <div class="details-media radius18" data-aos="fade-up" style="margin-bottom: 50px;">
                  <img src="{{ asset('assets/img/service/service.jpg') }}" width="1000" height="596" loading="lazy" alt="image">
                </div>
                <!-- GenAI Adoption for Institutions -->
                <div class="service-section mb-60 active" data-aos="fade-up" data-service="genai">
                  <h3 class="heading text-36" style="margin-bottom: 20px;">GenAI Adoption for Institutions</h3>
                  <p class="text text-18" style="margin-bottom: 20px;">
                    We help organisations unlock productivity and resilience by embedding Generative AI into their people, processes, and systems — driving efficiency, transparency, and readiness for the future of work.
                  </p>
               
                  <ul class="text-lists list-unstyled" style="margin-bottom: 20px;">
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Team Training:</strong> Practical sessions on using GenAI tools for efficiency.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Workforce Readiness:</strong> Equipping staff to adapt to new technologies.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Risk Management:</strong> Guardrails for safe and responsible AI adoption.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Process Transformation:</strong> Embedding GenAI into everyday workflows.</div>
                    </li>
                  </ul>
                </div>

                <!-- Public Sector & Development Consulting -->
                <div class="service-section mb-60" data-aos="fade-up" data-service="public-sector">
                  <h3 class="heading text-36" style="margin-bottom: 20px;">Public Sector & Development Consulting</h3>
                  <p class="text text-18" style="margin-bottom: 20px;">
                    Shaping policies and programs that create lasting impact.
                  </p>
                  <ul class="text-lists list-unstyled" style="margin-bottom: 20px;">
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div class="text text-18"><strong>Policy Formulation & Evaluation:</strong> Supporting governments and institutions in designing, assessing, and refining impactful policies.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Public-Private Partnerships (PPPs):</strong> Structuring and managing collaborations that leverage private sector expertise for public good.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Social Impact Program Design:</strong> Creating programs that address critical societal challenges with measurable outcomes.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Monitoring & Evaluation (M&E):</strong> Building systems to track, assess, and enhance the effectiveness of interventions.</div>
                    </li>
                  </ul>
                </div>

                <!-- Strategy & Leadership Advisory -->
                <div class="service-section mb-60" data-aos="fade-up" data-service="strategy">
                  <h3 class="heading text-36" style="margin-bottom: 20px;">Strategy & Leadership Advisory</h3>
                  <p class="text text-18" style="margin-bottom: 20px;">
                    Guiding institutions and leaders to thrive in times of disruption.
                  </p>
                  <ul class="text-lists list-unstyled" style="margin-bottom: 20px;">
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div class="text text-18"><strong>Leadership Retreats:</strong> Immersive programs with global experts.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Strategic Roadmaps:</strong> Clear, actionable plans for long-term growth.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Disruption Management:</strong> Helping leaders navigate digital and cultural shifts.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Corporate Strategy Development:</strong> Designing and implementing long-term corporate strategies that align with organizational vision, mission, and growth objectives.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Strategy & Leadership Advisory Strategy:</strong> Guiding businesses through structured frameworks for entering new markets and scaling operations effectively.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Business Model Innovation:</strong> Reimagining value creation through new models that strengthen competitiveness and sustainability.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Growth & Diversification Planning:</strong> Identifying opportunities for expansion, diversification, and sustainable revenue growth.</div>
                    </li>
                  </ul>
                </div>

                <!-- Training & Capacity Building -->
                <div class="service-section mb-60" data-aos="fade-up" data-service="training">
                  <h3 class="heading text-36" style="margin-bottom: 20px;">Training & Capacity Building</h3>
               
                  <p class="text text-18" style="margin-bottom: 20px;">
                    Equipping leaders and teams with skills to thrive in disruption.
                  </p>
                  <ul class="text-lists list-unstyled" style="margin-bottom: 20px;" >
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div class="text text-18"><strong>Executive Training Programs:</strong> Equipping leaders with tools for strategic decision-making and organizational transformation.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Strategy & Leadership Workshops:</strong> Developing leadership capabilities through interactive, problem-solving sessions.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Research & Data Literacy Bootcamps:</strong> Strengthening analytical skills to enable data-driven decision-making.</div>
                    </li>
                    <li class="text-item">
                      <svg class="icon-24" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.9999 6.99486L16.5899 5.58594L10.2499 11.9211L11.6599 13.33L17.9999 6.99486ZM22.2399 5.58594L11.6599 16.1578L7.47991 11.991L6.06991 13.3999L11.6599 18.9857L23.6599 6.99486L22.2399 5.58594ZM0.409912 13.3999L5.99991 18.9857L7.40991 17.5767L1.82991 11.991L0.409912 13.3999Z" fill="CurrentColor"></path>
                      </svg>
                      <div class="text text-18"><strong>Custom Learning Interventions:</strong> Designing tailored training programs to address specific organizational challenges.</div>
                    </li>
                  </ul>
                </div>
              </div>
  ...
  <scroll-top>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        const serviceLinks = document.querySelectorAll('.secvice-category');
        const serviceSections = document.querySelectorAll('.service-section');

        // Function to show only selected service
        function showService(serviceType) {
          serviceSections.forEach(section => {
            if (section.getAttribute('data-service') === serviceType) {
        ...
        // Initially show only the first service (genai) - the one with active class
        showService('genai');
        ...
        serviceLinks.forEach(link => {
          link.addEventListener('click', function(e) {
            ...
            const contentArea = document.querySelector('.service-details-content');
            if (contentArea) {
