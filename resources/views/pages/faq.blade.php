...
<html lang="en" class="no-js">
 ...
 <link rel="manifest" href="{{ asset('assets/img/site.webmanifest') }}">
    ...
    <meta name="description" content="Get answers to frequently asked questions about 229 Consulting's strategy development, transformation consulting, and leadership advisory services.">
    <meta name="keywords" content="FAQ 229 consulting, strategy consulting questions, transformation consulting, leadership advisory, business consulting">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:url" content="{{ url('/faq') }}">
    <meta property="og:title" content="Frequently Asked Questions - 229 Consulting">
    <meta property="og:description" content="Get answers to frequently asked questions about 229 Consulting's strategy development, transformation consulting, and leadership advisory services.">
    <meta property="og:type" content="website">
    <meta property="og:image" content="{{ asset('assets/img/consulting_logo.png') }}">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Frequently Asked Questions - 229 Consulting">
    <meta name="twitter:description" content="Get answers to frequently asked questions about 229 Consulting's strategy development, transformation consulting, and leadership advisory services.">
                ...
                <div class="faq-form-wrap radius18" data-aos="fade-up">
                  <form action="#" class="faq-form">
                    ...
                    <div class="field" data-aos="fade-up">
                      ...
                      <input id="FaqForm-name" class="text text-16" type="text" placeholder="Your Name" name="Full name" required="">
                    </div>
                    ...
                    <a href="#" data-aos="fade-up" data-aos-delay="50" class="button button--primary" aria-label="Ask Your Question">
                      Ask Question Now
                      <span class="svg-wrapper">
                        <svg class="icon-20" width="20" height="20" viewbox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M7.55664 2.88281L6.77097 3.66848L9.54875 6.44625H2.55664V7.55736H9.54875L6.77097 10.3351L7.55664 11.1208L11.6756 7.0018L7.55664 2.88281Z" fill="CurrentColor"></path>
                        </svg>
                      </span>
                    </a>
                  </form>
