...
<html lang="en" class="no-js">
  <head>
    <title>{{ isset($post) ? $post->title . ' - 229 Consulting' : 'Blog Details - 229 Consulting' }}</title>
    ...
    <meta name="description" content="{{ isset($post) && $post->sub_title ? $post->sub_title : 'Read detailed insights on business consulting topics including GenAI adoption, strategy, and transformation best practices from 229 Consulting experts.' }}">
    <meta name="keywords" content="{{ isset($post) && $post->tags->count() > 0 ? $post->tags->pluck('name')->implode(', ') : 'business consulting blog, GenAI adoption, business strategy, consulting insights, 229 consulting, business transformation' }}">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="{{ isset($post) ? $post->title . ' - 229 Consulting' : 'Blog Details - 229 Consulting' }}">
    <meta property="og:description" content="{{ isset($post) && $post->sub_title ? $post->sub_title : 'Dive deep into business consulting insights and strategies from 229 Consulting expert team.' }}">
                ...
                <drawer-menu>
                    <nav class="header-nav drawer-menu">
                        ...
                        <ul class="header-menu list-unstyled">
                            ...
                            <li class="nav-item">
                                <a class="menu-link menu-link-main active" href="/blog">
                                    Blog
                                </a>
    ...
    <main>
      ...
      <div class="page-banner overlay">
        <picture class="media media-bg">
          <source media="(max-width: 575px)" srcset="{{ asset('assets/img/banner/page-banner-575.jpg') }}">
          <source media="(max-width: 991px)" srcset="{{ asset('assets/img/banner/page-banner-991.jpg') }}">
          <img src="{{ asset('assets/img/banner/page-banner.jpg') }}" width="1920" height="520" loading="eager" alt="Page Banner Image">
        </picture>
        <div class="page-banner-content">
          <div class="container text-center">
            <h1 class="heading text-80 fw-700" data-aos="fade-up">
              {{ isset($post) ? $post->title : 'Blog Details' }}
            </h1>
            <ul class="breadcrumb list-unstyled" data-aos="fade-up" data-aos-delay="100">
              ...
              <li>
                <a href="/blog" class="text text-18" aria-label="Blog">
                  Blog
                </a>
              </li>
              @isset($post)
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-12 col-lg-7">
              <style>
                .blog-details .card-blog-list,
                .blog-details .card-blog-list-media,
                .blog-details .card-blog-content,
                .blog-details .card-blog-meta,
                .blog-details .media,
                .sidebar-widget .card-blog-list,
                .sidebar-widget .card-blog-list-media,
                .sidebar-widget .card-blog-content {
              ...
              <div class="blog-details">
                @isset($post)
                <div class="card-blog-list" data-aos="fade-up" style="border: none; outline: none; box-shadow: none;">
                  <div class="card-blog-list-media radius18" style="border: none; outline: none;">
                    <div class="media" style="border: none; outline: none;">
                      <img src="{{ $post->featurePhoto }}" alt="{{ $post->photo_alt_text ?? $post->title }}" width="1000" height="707" loading="lazy">
                    </div>
                  </div>

                  <div class="card-blog-content" style="border: none; outline: none;">
                    <div class="card-blog-meta" style="border: none;">
                      <div class="card-blog-meta-item text text-18">
                        <svg width="18" height="20" viewbox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M9.00098 0.650391C11.499 0.650391 13.5437 2.69437 13.5439 5.19238C13.5439 7.69056 11.4992 9.73535 9.00098 9.73535C6.50299 9.73517 4.45898 7.69045 4.45898 5.19238C4.45919 2.69448 6.50308 0.650569 9.00098 0.650391Z" stroke="currentColor" stroke-width="1.3"></path>
                      ...
                      <div class="card-blog-meta-item text text-18">
                        <svg width="18" height="16" viewbox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1.125 1.25H16.875V11.375H9L4.5 15.3125V11.375H1.125V1.25Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    ...
                    <h2 class="card-blog-heading heading text-50" style="margin-bottom: 10px;">
                      {{ $post->title }}
                    </h2>

                    @if($post->sub_title)
                    <p class="text text-20" style="margin-bottom: 8px; color: #5d666f;">
                      {{ $post->sub_title }}
                    </p>
                    @endif

                    <div class="blog-description">
                      {!! \Filament\Forms\Components\RichEditor\RichContentRenderer::make($post->body)->toHtml() !!}
                    </div>
                  </div>
                </div>
                @else
                <p class="text text-18">Blog post not found.</p>
                @endisset
              </div>
              ...
              <div class="blog-share" data-aos="fade-up">
                ...
                <div class="blog-share-item">
                  ...
                  <ul class="sidebar-tags list-unstyled">
                    ...
                    <li>
                      <a class="subheading subheading-bg text-18" href="/blog" aria-label="tag">
                        {{ $tag->name }}
                      </a>
                    </li>
                    @endforeach
              ...
              <div class="comments-form">
                ...
                @if(session('success'))
                  <div class="alert alert-success" style="padding: 1rem; margin-bottom: 1rem; background-color: #d4edda; border: 1px solid #c3e6cb; border-radius: 0.25rem; color: #155724;">
                    {{ session('success') }}
                  </div>
                @endif
                
                @if(session('error'))
                  <div class="alert alert-danger" style="padding: 1rem; margin-bottom: 1rem; background-color: #f8d7da; border: 1px solid #f5c6cb; border-radius: 0.25rem; color: #721c24;">
                    {{ session('error') }}
                  </div>
                @endif
                
                <form action="{{ route('blog.comment.store', ['slug' => $post->slug]) }}" method="POST" class="form contact-form">
                  @csrf
                  ...
                  <div class="field" data-aos="fade-up">
                    ...
                    <input id="CommentFormname" class="text text-16" type="text" placeholder="Your Name*" name="name" value="{{ old('name', auth()->check() ? auth()->user()->name : '') }}" required>
                    @error('name')
                  ...
                  <div class="field" data-aos="fade-up">
                    ...
                    <textarea id="CommentFormbody" class="text text-16" rows="4" placeholder="Type your comment*" name="comment" required>{{ old('comment') }}</textarea>
                    @error('comment')
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
                  </div>
              ...
              <div class="sidebar-filter drawer-blog-sidebar">
                ...
                <aside class="blog-sidebar">
                  <div class="sidebar-widget radius18" data-aos="fade-up">
                    ...
                    <form action="/blog" method="GET" class="form-blog-search">
                      <label for="blog-search-input" class="visually-hidden">
                        Search blog
                      </label>
                      <input type="text" id="blog-search-input" name="search" placeholder="Search here" class="text-18">
                      <button type="submit" class="button button--primary" aria-label="Search blog">
                        <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g clip-path="url(#clip0_9060_14029)">
                            ...
                            <path d="M17.5 17.5L12.5 12.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                          </g>
                          <defs>
                  ...
                  <div class="sidebar-widget radius18" data-aos="fade-up">
                    ...
                    <ul class="blog-categories list-unstyled">
                      ...
                      <li>
                        <a class="blog-category subheading subheading-bg text-18 fw-400" href="/blog?category={{ $category->slug }}" aria-label="blog category">
                          {{ $category->name }} @if($category->posts_count > 0)({{ $category->posts_count }})@endif
                  ...
                  <div class="sidebar-widget radius18" data-aos="fade-up">
                    ...
                    <ul class="recent-post list-unstyled">
                      @isset($recentPosts)
                        ...
                        <li>
                          <div class="card-blog-list" style="border: none; outline: none; box-shadow: none;">
                            <div class="card-blog-list-media" style="border: none; outline: none;">
                              <div class="media" style="border: none; outline: none;">
                                <img src="{{ $recentPost->featurePhoto }}" alt="{{ $recentPost->photo_alt_text ?? $recentPost->title }}" width="1000" height="707" loading="lazy">
                              </div>
                            </div>
                            ...
                            <div class="card-blog-content" style="border: none; outline: none;">
                              <div class="card-blog-meta" style="border: none;">
                                <div class="card-blog-meta-item text text-16">
                                  {{ $recentPost->formattedPublishedDate() }}
                                </div>
                              </div>

                              <h2 class="card-blog-heading heading text-20">
                                <a href="{{ route('blog.detail', ['slug' => $recentPost->slug]) }}" class="heading text-20">
                                  {{ $recentPost->title }}
                                </a>
                              </h2>
                            </div>
