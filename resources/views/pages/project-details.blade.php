...
<html lang="en" class="no-js">
  <head>
    <title>Project Details - 229 Consulting</title>
    ...
    <meta name="description" content="Explore detailed case studies and project outcomes from 229 Consulting's successful business transformation initiatives across industries.">
    <meta name="keywords" content="consulting case studies, project details, business transformation outcomes, GenAI implementation results, public sector consulting success, strategy execution results">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="Project Details - 229 Consulting">
    <meta property="og:description" content="Discover the detailed outcomes and methodologies behind our successful consulting projects and business transformations.">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Project Details - 229 Consulting">
    <meta name="twitter:description" content="Explore our detailed case studies and project outcomes from successful business transformations.">
  ...
  <sticky-header data-sticky-type="always">
        ...
        <div class="page-project-details mt-100">
            <div class="container">
                <div class="project-media radius18" data-aos="fade-up">
                    <img id="project-main-image" src="{{ asset('assets/img/project/img1.jpg') }}" width="1400" height="637" loading="lazy" alt="Project Image">
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-12">
                            <div class="content-details-inner">
                                <h2 id="project-title" class="heading text-50" data-aos="fade-up" style="margin-bottom: 30px;"></h2>
                                
                                <h3 class="heading text-28" data-aos="fade-up" style="margin-bottom: 20px; color: #17a2b8;">Project</h3>
                                <p id="project-description" class="text text-18" data-aos="fade-up" style="margin-bottom: 40px;"></p>

                                <h3 class="heading text-28" data-aos="fade-up" style="margin-bottom: 20px; color: #17a2b8;">Client</h3>
                                <p id="project-client" class="text text-18" data-aos="fade-up" style="margin-bottom: 40px;"></p>

                                <div id="impact-section" style="display: none;">
                                    <h3 class="heading text-28" data-aos="fade-up" style="margin-bottom: 20px; color: #17a2b8;">Impact</h3>
                                    <p id="project-impact" class="text text-18" data-aos="fade-up" style="margin-bottom: 40px;"></p>
                                </div>

                                <h3 class="heading text-28" data-aos="fade-up" style="margin-bottom: 20px; color: #17a2b8;">Engagement Background</h3>
                                <p id="project-background" class="text text-18" data-aos="fade-up" style="margin-bottom: 40px;"></p>

                                <h3 class="heading text-28" data-aos="fade-up" style="margin-bottom: 20px; color: #17a2b8;">Our Approach</h3>
                                <p id="project-approach" class="text text-18" data-aos="fade-up" style="margin-bottom: 40px;"></p>

                                <h3 class="heading text-28" data-aos="fade-up" style="margin-bottom: 20px; color: #17a2b8;">The Outcome</h3>
                                <p id="project-outcome" class="text text-18" data-aos="fade-up" style="margin-bottom: 40px;"></p>
                            </div>
                        </div>
                            ...
                            <div class="project-sidebar">
                                ...
                                <div class="sidebar-widget service-contact radius18" data-aos="fade-up">
                                  <div class="media media-bg overlay">
                                    <img src="{{ asset('assets/img/service/service.jpg') }}" width="1000" height="929" loading="lazy" alt="image">
                                  </div>
    ...
    <!-- Project Details Dynamic Loading -->
    <script>
      // Project data
      const projects = {
        'marcx': {
          title: 'MARCX & CONSTRUCTION',
          image: 'assets/img/project/img1.jpg',
          description: 'Design a commodity market\'s full operational framework.',
          client: 'MARCX & CONSTRUCTION LTD.',
          background: 'We collaborated with a partner to help Marcx & Construction design the largest modern commodity exchange market in Northwest Nigeria, aiming to boost regional trade.',
          approach: 'The Company conducted feasibility and technical studies, securing regulatory approvals, structuring finance, integrating technology, engaging partners, and designing the full governance and operational framework.',
          outcome: 'Produced a scalable blueprint projected to position the commodity market as a leading player in Northern Nigeria\'s US$27bn commodity sector, facilitating annual trade, strengthening agricultural value chains, driving market integration, and securing pre-approval from the SEC for the commodity exchange market license.'
        },
        'azman': {
          title: 'AZMAN AIRLINES',
          image: 'assets/img/project/img2.jpg',
          description: 'Pricing strategy design.',
          client: 'Azman Airlines',
          background: 'Azman Airlines, which is a leading Nigerian airline needed to optimize pricing for competitiveness and revenue growth, and we were brought on board.',
          approach: 'The Firm conducted competitor benchmarking, demand modeling, and fare structure optimization aligned with market dynamics.',
          outcome: 'Delivered a pricing strategy that improved revenues by 5% within 12 months.'
        },
        'stuffsmart': {
          title: 'STUFFS MART',
          image: 'assets/img/project/img3.jpg',
          description: 'Business expansion strategy.',
          client: 'Stuffs Mart',
          background: 'A retail business sought to expand its footprint and strengthen profitability in a competitive market.',
          approach: 'Designed a growth strategy covering market entry, operational rollout, and customer acquisition.',
          outcome: 'Improved profitability by ~15% in 9 months and expanded into 3 new locations within the first year.'
        },
        'ridgeville': {
          title: 'RIDGE VILLE APARTMENT',
          image: 'assets/img/project/img4.jpg',
          description: 'Full operational setup of an aparthotel.',
          client: 'Ridge Ville Apartment',
          background: 'An established hospitality company that was expanding into a new Nigerian city.',
          approach: 'Set up full operations, from business systems to social media rollout and business development.',
          outcome: 'Established Ridgeville as a trusted hospitality brand with 70% occupancy in 6 months, strong digital visibility, and repeat corporate clientele.'
        },
        'knightsbridge': {
          title: 'KNIGHTSBRIDGE HOTEL & SUITES',
          image: 'assets/img/project/img5.jpg',
          description: 'Advisory and operational support for expansion and business strategy.',
          client: 'Knightsbridge Hotel & Suites',
          background: 'A growing hospitality brand needed advisory support for expansion.',
          approach: 'Conducted market research, analysed consumer trends, restructured operations, and developed a long-term business strategy.',
          outcome: 'The Company established Knightsbridge as a strong boutique hotel that was rated 9/10 on the popular booking website: www.booking.com. Revenue grew by 18% within the first year, establishing Knightsbridge as a strong market player.'
        },
        'eksiogullari': {
          title: 'EKŞIOĞULLARI CONSTRUCTION',
          image: 'assets/img/project/img6.png',
          description: 'Divestment strategy during downturn.',
          client: 'Ekşioğullari Construction',
          background: 'A construction firm faced declining revenues during an industry downturn.',
          approach: 'Developed a phased divestment strategy by analyzing assets, reallocating capital into real estate and mining investments, and preserving liquidity.',
          outcome: 'Generated significant capital by strategically investing funds from divestment into real estate and mining, safeguarding shareholder value and strengthening operational resilience.'
        },
        'government': {
          title: 'GOVERNMENT AGENCY (CONFIDENTIAL)',
          image: 'assets/img/project/img7.jpg',
          description: 'Strategy retreat in London for two Nigerian government agencies.',
          client: 'Government Agency (Confidential) - Implemented in partnership with Jasmine Consulting',
          background: 'Two government agencies engaged the Firm to facilitate collaboration in jointly addressing institutional challenges.',
          approach: 'Facilitated a strategy retreat in London, using workshops, scenario planning, and governance frameworks to align stakeholders.',
          outcome: 'Established actionable roadmaps, improving inter-agency collaboration and policy implementation efficiency by ~25%.'
        },
        'healthcare': {
          title: 'HEALTHCARE PROJECT (CONFIDENTIAL)',
          image: 'assets/img/project/img8.jpg',
          description: 'End-to-end project management for the construction and setup of a modern hospital with a technical partner.',
          client: 'Healthcare Project (Confidential)',
          background: 'A healthcare initiative required structured execution across financing, procurement, and delivery.',
          approach: 'Partnered with technical experts to manage end-to-end construction, finance tracking, and stakeholder alignment.',
          outcome: 'Delivered a hospital project with zero delays, transparent procurement, and execution fully within the agreed timeline.'
        },
        'school': {
          title: 'PRIMARY & SECONDARY SCHOOL (CONFIDENTIAL)',
          image: 'assets/img/project/img9.jpg',
          description: 'Curriculum refinement to address challenges with technology adoption and classroom integration.',
          client: 'Primary & Secondary School (Confidential)',
          background: 'A private school struggled with integrating technology into classrooms.',
          approach: 'Assessed curriculum gaps, designed digital adoption pathways, and trained teachers on modern tools.',
          outcome: 'Significantly improved digital literacy among students and enhanced teacher readiness within the first year of implementation.'
        }
      };
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        // Get project data
        const project = projects[projectId] || projects['marcx']; 
        ...
        const pageBannerTitle = document.querySelector('.page-banner-content h1');
        if (pageBannerTitle) {
          pageBannerTitle.textContent = project.title;
        }
      });
    </script>
  </body>
