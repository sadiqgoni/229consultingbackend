...
<html lang="en" class="no-js">
  <head>
    <title>Our Projects - 229 Consulting</title>
    ...
    <meta name="description" content="Explore 229 Consulting's portfolio of successful business transformation projects across industries including GenAI adoption, public sector consulting, and strategy implementation.">
    <meta name="keywords" content="business consulting projects, case studies, GenAI implementation, public sector consulting, strategy execution, organizational transformation, consulting success stories">
    <meta property="og:site_name" content="229 Consulting">
    <meta property="og:title" content="Our Projects - 229 Consulting">
    <meta property="og:description" content="Discover our successful business consulting projects and case studies across diverse industries. From AI adoption to public sector transformation.">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Our Projects - 229 Consulting">
    <meta name="twitter:description" content="Explore our portfolio of business transformation projects and consulting success stories.">
    ...
    <div class="drawer-content">
      <div class="drawer-block">
        ...
        <ul class="drawer-additional-menu list-unstyled flex-direction-column">
          ...
          <li class="nav-item">
            <a class="menu-link" href="/projects">Our Projects</a>
          </li>
        </ul>
      </div>
      <div class="drawer-block drawer-block-contact">
        ...
        <div class="container-fluid">
          <div class="row product-grid">
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="100">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=marcx">
                <img src="{{ asset('assets/img/project/img1.jpg') }}" alt="MARCX & CONSTRUCTION project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
                    <h2 class="heading text-24">MARCX & CONSTRUCTION</h2>
                    <p class="text text-16">Commodity market framework design</p>
                  </div>
                </div>
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="200">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=azman">
                <img src="{{ asset('assets/img/project/img2.jpg') }}" alt="AZMAN AIRLINES project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="300">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=stuffsmart">
                <img src="{{ asset('assets/img/project/img3.jpg') }}" alt="STUFFS MART project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="400">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=ridgeville">
                <img src="{{ asset('assets/img/project/img4.jpg') }}" alt="RIDGE VILLE APARTMENT project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="100">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=knightsbridge">
                <img src="{{ asset('assets/img/project/img5.jpg') }}" alt="KNIGHTSBRIDGE HOTEL & SUITES project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="200">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=eksiogullari">
                <img src="{{ asset('assets/img/project/img6.png') }}" alt="EKŞIOĞULLARI CONSTRUCTION project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="300">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=government">
                <img src="{{ asset('assets/img/project/img7.jpg') }}" alt="GOVERNMENT AGENCY project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
                    <h2 class="heading text-24">GOVERNMENT AGENCY</h2>
                    <p class="text text-16">Strategy retreat in London</p>
                  </div>
                </div>
                <span class="svg-wrapper icon-project-link">
                  <svg viewbox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3" data-aos="fade-up" data-aos-delay="400">
              <a class="card-project radius18" aria-label="project details" href="/project-details?project=healthcare">
                <img src="{{ asset('assets/img/project/img8.jpg') }}" alt="HEALTHCARE PROJECT project image" width="645" height="690" loading="lazy">
                <div class="card-project-content-absolute">
                  <div class="card-project-content">
                    <h2 class="heading text-24">HEALTHCARE PROJECT</h2>
                    <p class="text text-16">Hospital construction and setup</p>
                  </div>
                </div>
                <span class="svg-wrapper icon-project-link">
                  <svg viewbox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
